...
public class Movies implements Serializable, Parcelable
{
    ...
    ;
    private final static long serialVersionUID = 4119617556068090429L;
    ...
    protected Movies(Parcel in) {
        ...
        this.backgroundColor = ((int) in.readValue(Integer.class.getClassLoader()));
    }
     ...
     */
    public Movies(@NonNull Long id, String url, String imdbCode, String title, String titleEnglish, String titleLong, String slug, Long year, Float rating, Long runtime, List<String> genres, String summary, String descriptionFull, String synopsis, String ytTrailerCode, String language, String mpaRating, String backgroundImage, String backgroundImageOriginal, String smallCoverImage, String mediumCoverImage, String largeCoverImage, String state, List<Torrent> torrents, String dateUploaded, Long dateUploadedUnix, int backgroundColor) {
        super();
        this.id = id;
        this.url = url;
